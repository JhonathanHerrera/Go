...
const file_proto_greeter_proto_rawDesc = "" +
	...
	"\fSayHelloMany\x12\x15.greeter.HelloRequest\x1a\x13.greeter.HelloReply\"\x000\x01B\fZ\n" +
...
var file_proto_greeter_proto_depIdxs = []int32{
	...
	0, // 1: greeter.Greeter.SayHelloMany:input_type -> greeter.HelloRequest
	1, // 2: greeter.Greeter.SayHello:output_type -> greeter.HelloReply
	1, // 3: greeter.Greeter.SayHelloMany:output_type -> greeter.HelloReply
